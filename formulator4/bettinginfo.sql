...
--
-- Table structure for table `bettinginfo`
--

DROP TABLE IF EXISTS `bettinginfo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bettinginfo` (
  `RCTrack` char(4) NOT NULL,
  `RCDate` date NOT NULL,
  `RCRace` tinyint(4) NOT NULL,
  `ProgNum` char(2) NOT NULL,
  `PostPosition` char(2) DEFAULT NULL,
  `Horse` varchar(22) NOT NULL,
  `Jockey` varchar(22) DEFAULT NULL,
  `MLOdds` char(5) DEFAULT NULL,
...
-- Dump completed on 2018-07-19  9:47:25
