...
--
-- Table structure for table `trackfactcombo`
--

DROP TABLE IF EXISTS `trackfactcombo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `trackfactcombo` (
  `RCDate` date NOT NULL,
  `RCTrack` char(4) NOT NULL,
  `DateHeading` varchar(128) DEFAULT NULL,
  `Ordinal` decimal(3,0) NOT NULL,
  `JTCode` enum('J','T') DEFAULT NULL,
  `Trainer` varchar(22) NOT NULL,
  ...
  `AvgWinPayoff` decimal(5,2) DEFAULT NULL,
