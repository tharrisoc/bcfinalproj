...
CREATE TABLE `specialproducts` (
  ...
  `BestFastDirt` smallint(6) DEFAULT NULL,
  `BestTurf` smallint(6) DEFAULT NULL,
  `BestWet` smallint(6) DEFAULT NULL,
  `BestDistance` smallint(6) DEFAULT NULL,
  `BestLifetime` smallint(6) DEFAULT NULL,
  `BestCurrentYear` smallint(6) DEFAULT NULL,
  `BestPriorYear` smallint(6) DEFAULT NULL,
  `BestTrackSurface` smallint(6) DEFAULT NULL,
  `MudTurfMud` char(4) DEFAULT NULL,
  `MudTurfTurf` char(4) DEFAULT NULL,
  `MudTurfDistance` char(4) DEFAULT NULL,
